        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">           
              Are you ready to mint your very own <strong>Hot Dawg</strong>? <span className="emoji">🌭</span><br /><br />
              If you don't trust our site, you can interact with the smart-contract <strong>directly</strong> through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a>, without connecting here! <span className="emoji">😃</span><br />
              <br />
              Keep safe! <span className="emoji">❤️</span>
            </div><br />
            <img src={require('../../images/pfp_gif.gif')} alt="loading..." />
          </div>
          : null}
      </>
    );
